...
(function (e, t)
{
	...
	{
		for (var n, a, r = s.call(arguments, 1), o = 0, h = r.length; h > o; o++) for (n in r[o]) a = r[o][n], r[o].hasOwnProperty(n) && a !== t && (i[n] = e.isPlainObject(a) ? e.isPlainObject(i[n]) ? e.widget.extend(
		{
...
(function (t, e)
{
	...
	}, t.fn.position = function (e)
	{
		...
		return b = n(_), _[0].preventDefault && (e.at = "left top"), p = b.width, m = b.height, g = b.offset, v = t.extend(
		{
...
(function (e)
{
	...
	e.widget("ui.resizable", e.ui.mouse, {
		...
		_create: function ()
		{
			...
			{
			}, i = 0; t.length > i; i++) s = e.trim(t[i]), a = "ui-resizable-" + s, n = e("<div class='ui-resizable-handle " + a + "'></div>"), n.css(
			{
				zIndex: r.zIndex
...
(function (t)
{
	...
	t.widget("ui.sortable", t.ui.mouse, {
		...
		_create: function ()
		{
			...
			this.containerCache =
			{
			}, this.element.addClass("ui-sortable"), this.refresh(), this.floating = this.items.length ? "x" === t.axis || i(this.items[0].item) : !1, this.offset = this.element.offset(), this._mouseInit(), this.ready = !0
		},
		_destroy: function ()
		{
...
(function (t, e)
{
	...
	t.extend(i.prototype, {
		...
		{
			var s, n, a;
			s = e.nodeName.toLowerCase(), n = "div" === s || "span" === s, e.id || (this.uuid += 1, e.id = "dp" + this.uuid), a = this._newInst(t(e), n), a.settings = t.extend(
			{
			}, i || {
		...
		_dialogDatepicker: function (e, i, s, a, o)
		{
			...
			{
			}, t.data(this._dialogInput[0], r, p)), n(p.settings, a || {
		...
		_showDatepicker: function (e)
		{
			...
			{
				var i, s, a, r, o, h, l;
				i = t.datepicker._getInst(e), t.datepicker._curInst && t.datepicker._curInst !== i && (t.datepicker._curInst.dpDiv.stop(!0, !0), i && t.datepicker._datepickerShowing && t.datepicker._hideDatepicker(t.datepicker._curInst.input[0])), s = t.datepicker._get(i, "beforeShow"), a = s ? s.apply(e, [e, i]) : {
...
(function (t)
{
	...
	t.widget("ui.dialog", {
		...
		_position: function ()
		{
			...
			{
			}, t.ui.dialog.prototype.options.position, i)) : i = t.ui.dialog.prototype.options.position, e = this.uiDialog.is(":visible"), e || this.uiDialog.show(), this.uiDialog.position(i), e || this.uiDialog.hide()
		}
	})
})(jQuery);
(function (t)
...
(function (t)
{
	t.effects.effect.bounce = function (e, i)
	{
		...
		{
		}, n[v] = (_ ? "-=" : "+=") + d, o.animate(n, m, g).animate(a, m, g), d = l ? 2 * d : d / 2;
		l && (n =
		{
			opacity: 0
